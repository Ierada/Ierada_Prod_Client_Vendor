...
import { editDesigner, getAllDesigners } from "../../../services/api.designerUser";

const DesignerModal = ({ isOpen, onClose, mode, designer }) => {
  ...
  useEffect(() => {
    if (designer && mode !== "add") {
      // Set basic designer information
      setFormData({
        ...
        bio: designer.bio || "",
        tags: designer.tags || "",
        is_popular: designer.is_popular || false,
      });

      // Set avatar preview
      setAvatar({
        file: null,
        preview: designer.avatar || null,
      });
    }
  }, [designer, mode]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await editDesigner(designer?.id, formDataToSend);            
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">
              {mode === "view" ? "View Designer" : mode === "edit" ? "Edit Designer" : "Add Designer"}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Popular Designer</label>
                  {mode === "view" ? (
                    <p>{designer.is_popular ? "Yes" : "No"}</p>
                  ) : (
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span>Mark as Popular Designer</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg border shadow-sm p-6">
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2">Designer Avatar</label>
                {mode !== "view" && (
